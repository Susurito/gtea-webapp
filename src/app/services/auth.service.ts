...
const session_cookie_name = 'gtea-token';
const user_email_cookie_name = 'gtea-email';
const user_id_cookie_name = 'gtea-user_id';
const user_complete_name_cookie_name = 'gtea-user_complete_name';
const group_name_cookie_name = 'gtea-group_name';
const codigo_cookie_name = 'gtea-codigo';
